...
//"Declaration" de função
            //Termo "declaration"
                ...
                //Declaration é um statement (declaração) que especificamente introduz um identificador. Variáveis, por exemplo, são nomeadas. E, no nosso caso, funções também.
    ...
    //A palavra-chave "function" é escrita primeiro, e então o nome da função (seu identificador), e então uma lista de parâmetros entre parênteses (separados por vírgula (comma), vazios no exemplo acima (explicação adiante)) e finalmente o código da função, também chamado de "corpo da função", entre chaves '{}'.
